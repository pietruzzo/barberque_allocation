...
void * ScallopSchedPol::Create(PF_ObjectParams *) {
	return new ScallopSchedPol();
}

int32_t ScallopSchedPol::Destroy(void * plugin) {
	if (!plugin)
		return -1;
	delete (ScallopSchedPol *)plugin;
	return 0;
}

// ::::::::::::::::::::: Scheduler policy module interface :::::::::::::::::::

char const * ScallopSchedPol::Name() {
	return SCHEDULER_POLICY_NAME;
}

ScallopSchedPol::ScallopSchedPol():
	...
	if (logger)
		logger->Info("scallop: Built a new dynamic object[%p]", this);
	else
		fprintf(stderr,
				FI("scallop: Built new dynamic object [%p]\n"), (void *)this);
}
...
ScallopSchedPol::ExitCode_t ScallopSchedPol::Init() {
