...
public:
	...
	{
		return exc_status.is_registered;
	}
	 ...
	 * @ingroup rtlib_sec02_aem_constr
	 */
	RTLIB_ExitCode_t SetGoalGap(int goal_gap_percent);
	 ...
	 */
	const char * GetUniqueID_String() const;
	 ...
	 * @ingroup rtlib_sec02_aem_utils
	 */
	RTLIB_ExitCode_t SetMinimumCycleTimeUs(uint32_t min_cycle_time_us);
	...
	{
		return exc_status.has_finished_processing;
	}
...
private:
	...
	*/
	...
	std::condition_variable control_cond_variable;
	...
	RTLIB_ExitCode_t CheckConfigure();
